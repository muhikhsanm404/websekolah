...
<div class="col-sm-4">
	<div class="list-group">
		<span class="list-group-item text-white" style="background-color: #22b0f2">Artikel Terbaru</span>
	...
	<div class="list-group">
		<span class="list-group-item text-white mt-3" style="background-color: #22b0f2">Kategori Artikel</span>
